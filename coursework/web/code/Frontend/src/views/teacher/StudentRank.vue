      ...
      <div v-if="submitted===false">
        <b-row class="line-control" align-v="center">
          <b-col class="text-center">
            <b-alert show>成绩未提交!</b-alert>
          </b-col>
        </b-row>
      </div>
      <div v-if="submitted===true && classInfo !== null">
        <b-row class="line-control" align-v="center">
          <b-col class="text-center">
            平均成绩(只计算有成绩的学生): {{averageScore}}
          </b-col>
        </b-row>
        <b-row class="line-control" align-v="center">
          <b-col class="text-center">
    ...
    watch: {
      ...
      classFullName: function (newVal, oldVal) {
        if (this.academicYear !== null && this.term !== null
          ...
          axios({
            method: 'post',
            url: '/controller/isScoreSubmittedByTeacher',
            data: {
            ...
            if (response.data !== 'ILLEGAL') {
              this.submitted = response.data === true
            } else {
              this.$notify({
                group: 'notify',
                type: 'error',
          ...
          axios({
            ...
            if (response.data !== 'ILLEGAL') {
              ...
              this.classInfo.sort(function (l, r) {
